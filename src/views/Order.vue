        ...
        <div class="box">
            ...
            <div class="address f-16 mx-5">
                ...
                <select class="add-select mr-3" v-model="selected">
                    <option v-for="(ad,i) of address" :key="i" :value="ad.address_id">
                        {{ad.address}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ad.cellphone}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ad.receiver}}
                    </option>
                </select>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button class="cancel-btn" data-dismiss="modal">取消
                                </button>
                                <button :disabled="!canSave" :title="!canSave?'输入后才能保存':''" @click="addAddress" class="add-btn" data-dismiss="modal">保存
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                ...
                <div class="mx-5 my-4 order">
                    ...
                    <button @click="addOrder" :disabled="!canSubmit" class="go-order" :title="!canSubmit?'请添加收货地址':''">提交订单</button>
                </div>
            </div>
        </div>
...
export default {
    ...
    updated(){
        ...
        if(this.newPostcode!==""&&this.newAddress!==""&&this.newReceiver!==""&&this.newCellphone!==""){
            this.canSave = true
        }else{
            this.canSave = false;
        }
    ...
    methods:{
        ...
        addAddress(){
            ...
            funs.addAddress(url,obj,callback);
        },
        //创建订单
        addOrder(){
            var url = "/addorder";
            ...
            funs.addOrder(url,obj,callback);
        }
    }
}
</script>
